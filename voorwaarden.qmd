# Voorwaarden voor lineaire regressie {#sec-voorwaarden}
...
Je kunt dit het eenvoudigst beoordelen door een residuendiagram te beoordelen. Er bestaan formele toetsen voor deze voorwaarde zoals de [Durbin-Watson test](https://en.wikipedia.org/wiki/Durbin%E2%80%93Watson_statistic).

Wanneer er sprake is van autocorrelatie kun je "differencing" toepassen.
